...
def _build_parser() -> argparse.ArgumentParser:
    ...
    launch.add_argument("--timesteps", type=int, default=None, help="Training timesteps per trial (default: 500k, or from search-space file)")
    launch.add_argument("--n-envs", type=int, default=None, help="Parallel environments per trial (default: 4, or from search-space file)")
    ...
    launch.add_argument("--trials", type=int, default=None, help="Maximum number of trials (default: 20, or from search-space file)")
    launch.add_argument("--parallel", type=int, default=None, help="Parallel trials running at once (default: 5, or from search-space file)")
