...
| Plant contract revisions | policy r4; physics r2; visual r3 ([details](docs/PLANT_CONTRACT.md)) |
...
| Plant contract revisions | policy r4; physics r3; visual r3 ([details](docs/PLANT_CONTRACT.md)) |
