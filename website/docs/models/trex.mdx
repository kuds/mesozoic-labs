...
<SpeciesVideoSection
  species="T-Rex"
  stages={[
    { number: 1, title: 'Balance', description: 'Stable bipedal stance', video: '/videos/trex_ppo_stage1_best.mp4' },
    { number: 2, title: 'Locomotion', description: 'Walk and run toward prey', video: '/videos/trex_ppo_stage2_best.mp4' },
    { number: 3, title: 'Hunting', description: 'Sprint and bite prey with jaws', video: '/videos/trex_ppo_stage3_best.mp4' },
  ]}
/>
