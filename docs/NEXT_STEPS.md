...
follow-up checks the final pair like a periodic one: 1,585 lines).
...
- **D-D16** (#558, the notebook-safety PR, outside the numbered sequence) The
  ...
  refuses a node `RETRAIN_FROM` covers; `QUICK_TEST` runs live under
