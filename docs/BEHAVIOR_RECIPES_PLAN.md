...
landed as #552 and PR-14 (split into PR-14a, PR-14b and PR-14c by D-D15) as #553, #554 and #555 on 2026-09-24; PR-7 (the ground-height hook, `TRexBehaviorEnv` deleted) in review). Training runs in parallel
